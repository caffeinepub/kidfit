import { c as createLucideIcon, a as useUserProfile, m as useInternetIdentity, r as reactExports, o as useCreateBattle, p as useJoinBattle, q as useUpdateBattleScore, s as useSendBattleChat, t as useGetBattle, v as useGetBattleChats, u as ue, j as jsxRuntimeExports, S as Swords, l as cn, V as Variant_active_finished_waiting } from "./index-wWxEgrGs.js";
import { B as Button } from "./button-BNiSM2VH.js";
import { I as Input } from "./input-DLd1N_vF.js";
import { u as useCamera, S as Share2, d as Copy, C as Camera, a as CircleAlert, R as RefreshCw, b as RotateCcw, c as ShareResultModal } from "./ShareResultModal-DLWsjUcr.js";
import { g as getTierFromXp } from "./xp-wpql39xV.js";
import { m as motion } from "./proxy-Bj4tvbkF.js";
import { L as LoaderCircle } from "./loader-circle-Cu9AffNG.js";
import { T as Trophy } from "./trophy-DtD1sVO9.js";
import { C as CircleCheckBig } from "./circle-check-big-D0BqkZL-.js";
import { A as AnimatePresence } from "./index-XnM18BlU.js";
import "./dialog-DGTunPoP.js";
import "./index-DekapTDg.js";
import "./index-UMV473YT.js";
import "./x-DLFPGvHf.js";
import "./check-DR3A-Yex.js";
/**
...
function BattlePage() {
  ...
  const [_cameraError, setCameraError] = reactExports.useState(false);
  const [cameraRetryKey, setCameraRetryKey] = reactExports.useState(0);
  ...
  reactExports.useEffect(() => {
    ...
    setChatMessages((prev) => {
      ...
      const merged = [...mapped, ...optimisticOnly].sort(
  ...
  const [isInPosition, setIsInPosition] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      try {
        ...
        ue.info("Mic ready — tap the mic button to unmute.", {
          duration: 3e3
        });
      } catch {
        ue.error("Mic permission denied. You can still use text chat.", {
          duration: 4e3
        });
      }
    })();
  ...
  const detectLoop = reactExports.useCallback(() => {
    ...
    setIsInPosition(
      (prev) => prev !== motionStateRef.current.inPosition ? motionStateRef.current.inPosition : prev
    );
  ...
  const handleSendChat = async () => {
    ...
    const optimisticMsg = {
      id: `opt-${Date.now()}`,
      text,
      time: formatChatTime(/* @__PURE__ */ new Date()),
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-sporty p-6 space-y-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: "Ask your friend for their 6-character battle code." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-body text-muted-foreground flex items-center gap-1.5 px-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-3.5 h-3.5 text-neon-green" }),
                "Your Camera"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    !isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-muted/80", children: error ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body px-4 mb-2", children: "Camera unavailable" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                    ...
                    isActive && !isInPosition && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3 px-3 py-1 rounded-full border font-display font-bold text-xs z-10 bg-amber-500/20 border-amber-500/40 text-amber-400", children: "HOLD STILL..." }),
                    isActive && isInPosition && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: cn(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: isMuted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { className: "w-4 h-4" }),
                    "🎤 Unmute My Mic"
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/30 text-xs text-center mt-1", children: "Controls your own mic only" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  iWon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none overflow-hidden", children: [
                    "🎉",
                    "⭐",
                    "💪",
                    "🏆",
