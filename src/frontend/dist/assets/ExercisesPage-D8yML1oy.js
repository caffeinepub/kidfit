import { c as createLucideIcon, r as reactExports, d as useCategories, e as useExercisesByCategory, f as useLogWorkoutSession, j as jsxRuntimeExports, D as Dumbbell, u as ue } from "./index-DolueZgJ.js";
import { B as Badge } from "./badge-52PxlWkn.js";
import { B as Button } from "./button-51do7E5m.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription, X } from "./dialog-DK7AtQpF.js";
...
const GYM_PLANS = [
  {
    ...
    day: "Tuesday – Gym",
    emoji: "💪",
    description: "Same movements, heavier load. Use gym equipment for maximum gains.",
    category: "gym",
    exercises: [
      { name: "Jumping Jacks", type: "WARMUP", duration: 60 },
      {
  ...
  },
  {
    ...
    day: "Wednesday – Gym",
    emoji: "🔥",
    description: "Core-focused training with heavier resistance for maximum abs definition.",
    category: "gym",
    exercises: [
      { name: "Jumping Jacks", type: "WARMUP", duration: 60 },
      {
            ...
            children: [
              ...
              step.kind === "strength" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                step.exercise.note ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-amber-400/60 text-xs font-body text-center font-semibold", children: [
                  "💡 ",
                  step.exercise.note
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/30 text-xs font-body text-center", children: "Use bags or household items instead of dumbbells" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
