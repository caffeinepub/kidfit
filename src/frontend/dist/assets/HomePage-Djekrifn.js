import { c as createLucideIcon, R as React2, r as reactExports, j as jsxRuntimeExports, u as ue, a as useUserProfile, b as useMyStreak, D as Dumbbell, T as Target, U as User } from "./index-wWxEgrGs.js";
import { B as Button } from "./button-BNiSM2VH.js";
import { P as Progress, R as RewardedAdModal } from "./RewardedAdModal-9pBu7ltt.js";
import { S as Skeleton } from "./skeleton-3JbPUFVm.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-DGTunPoP.js";
import { I as Input } from "./input-DLd1N_vF.js";
import { L as Label } from "./label-JsU7f2Qv.js";
import { m as motion } from "./proxy-Bj4tvbkF.js";
import { F as Flame, u as useAdUnlock, a as usePushUpStats } from "./usePushUpStats-Bp39nSc9.js";
import { Z as Zap } from "./zap-CRtUD7i2.js";
import { A as AnimatePresence } from "./index-XnM18BlU.js";
import { T as TierBadge } from "./TierBadge-HzdJUiR_.js";
import { g as getTierFromXp, a as getXpProgress, b as getXpToNextTier, c as getTierInfo, T as Tier, l as levelFromXp } from "./xp-wpql39xV.js";
import { S as Star } from "./star-p7f1V_Jm.js";
import { L as Lock } from "./lock-BqSGd5Lh.js";
import { T as Trophy } from "./trophy-DtD1sVO9.js";
import "./index-DekapTDg.js";
import "./index-UMV473YT.js";
import "./x-DLFPGvHf.js";
...
const DailyMissionCard$1 = React2.memo(DailyMissionCard);
const TIER_ORDER = [
  Tier.bronze,
  Tier.silver,
  Tier.gold,
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-16 h-8 rounded-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(TierBadge, { tier, size: "sm" })
          ] })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 px-4 space-y-4", children: [
      currentStreak > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body mt-0.5", children: "Come back tomorrow to keep it alive" })
            ] })
          ]
        }
      ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-sm flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-4 h-4 text-primary" }),
                "🔒 Your Progress"
              ] }),
              isUnlocked && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-emerald-400 font-body font-medium", children: "✓ Unlocked for 5 hrs" })
            ] }),
            isUnlocked ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 rounded-xl p-3 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-3xl text-primary", children: stats.totalPushUps.toLocaleString() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body mt-0.5", children: "Total Push-Ups" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 rounded-xl p-3 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-3xl text-neon-cyan", children: stats.sessionCount }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body mt-0.5", children: stats.sessionCount === 1 ? "1 time" : `${stats.sessionCount} times` })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body mb-2 font-medium uppercase tracking-wide", children: "Badges Earned" }),
                stats.badges.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body italic", children: "Complete sessions to earn badges!" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: stats.badges.map((badge) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter blur-sm pointer-events-none select-none", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 rounded-xl p-3 text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-3xl text-primary", children: "247" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body mt-0.5", children: "Total Push-Ups" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 rounded-xl p-3 text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-3xl text-neon-cyan", children: "12" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-body mt-0.5", children: "12 times" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 text-xs bg-primary/10 border border-primary/30 text-primary rounded-full px-2.5 py-1 font-body", children: "🎯 First Rep" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 text-xs bg-primary/10 border border-primary/30 text-primary rounded-full px-2.5 py-1 font-body", children: "💪 10 Rep Club" })
                ] })
              ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DailyMissionCard$1, { username: (profile == null ? void 0 : profile.username) ?? "athlete" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 10 },
