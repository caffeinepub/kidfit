import { c as createLucideIcon, r as reactExports, a as useUserProfile, p as useInternetIdentity, q as useUserRole, s as useActor, t as useQueryClient, j as jsxRuntimeExports, v as getSecretParameter, u as ue } from "./index-j5uH3y76.js";
import { B as Button } from "./button-C3CVoxJl.js";
import { S as Star, P as Progress, R as RewardedAdModal } from "./RewardedAdModal-DVqvCwHo.js";
import { S as Skeleton } from "./skeleton-DCnBEQ-r.js";
import { U as UserRole, T as Tier } from "./backend.d-AW0U9QfA.js";
...
import { E as EyeOff, a as Eye } from "./eye-_c9_X4ve.js";
import { C as Calendar } from "./calendar-Bp5sa7cS.js";
...
function ProfilePage({ onNavigate }) {
  ...
  const handleClaimAdmin = async () => {
    ...
    if (!actor) {
      ue.error("Not connected yet, please wait.");
      return;
    }
    setClaiming(true);
    try {
      ...
      ue.success("You are now admin!");
    } catch (e) {
      const msg = e instanceof Error ? e.message : String(e);
      ue.error(
        msg.includes("Invalid") ? "Wrong admin token." : "Failed to claim admin."
      );
    } finally {
      setClaiming(false);
    }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            variant: "outline",
            size: "sm",
            onClick: () => onNavigate == null ? void 0 : onNavigate("admin"),
