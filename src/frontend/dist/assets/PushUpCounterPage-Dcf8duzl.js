import { c as createLucideIcon, r as reactExports, k as useLogPushups, a as useUserProfile, j as jsxRuntimeExports, T as Target, l as cn, u as ue } from "./index-wWxEgrGs.js";
import { B as Button } from "./button-BNiSM2VH.js";
import { u as useCamera, R as RefreshCw, C as Camera, a as CircleAlert, b as RotateCcw, S as Share2, c as ShareResultModal } from "./ShareResultModal-DLWsjUcr.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen gradient-mesh pb-36", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 px-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full rounded-2xl overflow-hidden bg-muted aspect-[4/3] border border-border", children: [
        ...
        isActive && !isDetecting && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
        ...
        isActive && isDetecting && !isInPosition && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3 z-20 px-3 py-1 rounded-full border font-display font-bold text-xs bg-amber-500/20 border-amber-500/40 text-amber-400", children: "HOLD STILL..." }),
        isActive && isDetecting && isInPosition && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
              "absolute top-3 left-3 z-20 px-3 py-1 rounded-full border font-display font-bold text-xs",
      ...
      isDetecting && !isInPosition && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: "⚠️ Get into push-up position and hold still..."
        }
      ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              style: {
                textShadow: repPulse || manualPulse ? "0 0 60px oklch(0.9 0.28 90 / 0.9), 0 0 120px oklch(0.85 0.25 90 / 0.5)" : "0 0 40px oklch(0.85 0.22 130 / 0.5), 0 0 80px oklch(0.85 0.22 130 / 0.2)"
              },
              children: count
            },
            countKey
      ...
      !sessionStarted && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-sporty p-4 space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 text-xs text-muted-foreground font-body", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Get into push-up position and hold still for 2 seconds" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Detection starts automatically once you're steady" }),
